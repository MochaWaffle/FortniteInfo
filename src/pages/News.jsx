    ...
    return (
        <>
            <div className="containerResize">
                <NewsInfo 
                    newsTitle = {brNewsTitle}
                    newsText = {brNewsText}
                    newsImage = {brNewsImage}
                    newsType = 'Battle Royale'
                />
                <br />
                <br />
                <NewsInfo
                    newsTitle = {stwNewsTitle}
                    newsText = {stwNewsText}
                    newsImage = {stwNewsImage}
                    newsType = 'Save The World'
                />
                <br />
                <br />
                <NewsInfo
                    newsTitle = {creativeNewsTitle}
                    newsText = {creativeNewsText}
                    newsImage = {creativeNewsImage}
                    newsType= 'Creative'
                />
            </div>
        </>
